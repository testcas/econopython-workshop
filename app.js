...
const { Play, RotateCcw, Lightbulb, CheckCircle, Lock, Trophy, Flame, TrendingUp } = lucide;
...
const EconoPython = () => {
    ...
    const levels = [
        ...
        },
        {
            ...
            expectedOutput: "2.5",
            hint: "Create a variable: gdp_growth = 2.5, then print it: print(gdp_growth)",
        ...
        },
        {
            ...
            hint: "Use f-strings for formatting: print(f'Analysis for: {country}')",
        ...
        },
        {
            ...
            hint: "Divide nominal GDP by price level: real_gdp = nominal_gdp / price_level",
        ...
        },
        {
            ...
            hint: "Use if statement to check the condition: if unemployment_rate > 8.0:",
        ...
        },
        {
            ...
            expectedOutput: "10\n9.0\n8.1\n7.29\n6.561\n5.9049\n5.31441",
            hint: "Use while loop: while value >= 5: print(value); value = value * 0.9",
            solution: "value = 10\nwhile value >= 5:\n    print(value)\n    value = value * 0.9"
        },
        {
            id: 7,
            ...
            expectedOutput: "2800",
            hint: "Create dict: indicators = {'country': 'UK', 'gdp': 2800, 'unemployment': 4.2}",
        ...
        },
        {
            ...
            hint: "Loop through unemployment rates: for rate in unemployment_rates: print(rate * 100)",
        ...
        try {
            ...
            while ((match = printRegex.exec(code)) !== null) {
                ...
                if (value.startsWith("'") && value.endsWith("'")) {
                    ...
                    if (code.includes('gdp_growth = 2.5')) matches.push('2.5');
                    if (code.includes('real_gdp = nominal_gdp / price_level')) matches.push('952.3809523809524');
                    if (code.includes('indicators[\'gdp\']')) matches.push('2800');
                    if (code.includes('Hello, World!')) matches.push('Hello, World!');
                    if (code.includes('High unemployment detected')) matches.push('High unemployment detected');
                }
            }
                ...
                <div className="max-w-7xl mx-auto px-4 py-4">
                    ...
                    <div className="mt-4">
                        <div className="flex justify-between text-sm text-gray-600 mb-1">
                            <span>Econometric Python Skills Progress</span>
                    ...
                    <div className="bg-white rounded-xl max-w-5xl w-full max-h-[80vh] overflow-y-auto">
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-bold text-gray-800">Select Econometric Python Level</h2>
                                <button
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6">
                        <div className="mb-6">
                            ...
                            <div className="bg-indigo-50 border-l-4 border-indigo-500 p-4 rounded-r-lg">
                                <h3 className="font-semibold text-indigo-800 mb-2">📊 Econometric Task:</h3>
                ...
                <div className="mt-12 bg-white rounded-xl shadow-lg p-6">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 mb-4">
                            King's College London • Interactive Python fundamentals for econometric analysis
                        </p>
...
// Render the app
ReactDOM.render(<EconoPython />, document.getElementById('root'));
